        ...
        {loading ? (
          ...
          <div className="flex flex-col w-full h-full">
            ...
            <div className="flex flex-col items-center justify-center mb-12">
               ...
               <Link href="/admin/settings/profile/edit" className="px-6 py-2 border border-zinc-300 text-zinc-700 hover:border-[#154212] hover:text-[#154212] hover:bg-zinc-50 font-bold text-[13px] rounded-lg transition-all shadow-sm">
                 Edit Profil
               </Link>
            </div>
